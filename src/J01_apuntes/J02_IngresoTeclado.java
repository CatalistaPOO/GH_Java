...
import java.util.Scanner;//alias de Scanner que es una clase de Java,apunta a su path (java/util/Scanner);

public class J02_IngresoTeclado {
	...
	public static void main(String[]arg) {
		...
		if (nombre.equals("Pablo")) //para comparar strings usaremos el metodo equals y no ==
